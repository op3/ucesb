...
DECL_PRIMITIVE_WATCHER(DATA14);
DECL_PRIMITIVE_WATCHER(DATA14_RANGE);
DECL_PRIMITIVE_WATCHER(DATA14_OVERFLOW);
DECL_PRIMITIVE_WATCHER(DATA16);
DECL_PRIMITIVE_WATCHER(DATA16_OVERFLOW);
...
DECL_PRIMITIVE_WATCHER(rawdata14);
DECL_PRIMITIVE_WATCHER(rawdata16);
DECL_PRIMITIVE_WATCHER(rawdata16plus);
