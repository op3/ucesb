...
typedef data_correlation<DATA14> DATA14_correlation;
typedef data_correlation<DATA14_RANGE> DATA14_RANGE_correlation;
typedef data_correlation<DATA14_OVERFLOW> DATA14_OVERFLOW_correlation;
typedef data_correlation<DATA16> DATA16_correlation;
typedef data_correlation<DATA16_OVERFLOW> DATA16_OVERFLOW_correlation;
...
typedef data_correlation<rawdata14> rawdata14_correlation;
typedef data_correlation<rawdata16> rawdata16_correlation;
typedef data_correlation<rawdata16plus> rawdata16plus_correlation;
