...
SIGNAL(TOGGLE 1: POS2_1_E,vme.qdc0.data[4],DATA12);
...
SIGNAL(ZZP1_1_F_1,vme.tdc2.data[3],(DATA12,float));
SIGNAL(ZERO_SUPPRESS: ZZP1_1_F_10);
SIGNAL(ZZP1_1_D_1,vme.tdc2.data[4],(DATA12,double));
SIGNAL(ZERO_SUPPRESS: ZZP1_1_D_10);
SIGNAL(ZZP1_1_U_1,vme.tdc2.data[5],(DATA12,uint32));
SIGNAL(ZERO_SUPPRESS: ZZP1_1_U_10);
SIGNAL(ZZP1_1_L_1,vme.tdc2.data[6],(DATA12,uint64));
