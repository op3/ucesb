 ...
 *                      structure is implied.
 * @key_id              Returns unique integer to identify the structure,
 ...
 * @key_id          Key of next structure to retrieve, 0 if name_id = "".
 *
 ...
 * @key_id          Key of structure to clear, 0 if name_id = "".
 *
