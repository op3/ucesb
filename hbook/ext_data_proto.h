...
#define EXTERNAL_WRITER_FLAG_TYPE_UINT64HI  EXT_DATA_ITEM_TYPE_UINT64HI
#define EXTERNAL_WRITER_FLAG_TYPE_UINT64LO  EXT_DATA_ITEM_TYPE_UINT64LO
...
#define EXTERNAL_WRITER_MAGIC (0x57e65c73u +36) // change with protocol version
